...
<div id="content">
    <div id="main">
        ...
        <div class="alertPre">Уважаемые клиенты! В связи с ограниченным количеством товаров магазина, мы вынуждены ввести условие предоплаты заказа в размере 100 грн. После предоплаты товару сразу отправляется покупателю. Спасибо за понимание! </div>
