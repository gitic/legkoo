...
<div id="content">
    <div id="main">
        ...
        <div id="newProduct">
            <?php
                $sql = "SELECT t1.*,t2.title AS category FROM products AS t1 LEFT JOIN categories AS t2 ON t1.category=t2.id WHERE t1.visible='1' AND t1.quantity ORDER BY id DESC LIMIT 0,3";
