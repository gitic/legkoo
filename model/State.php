...
class State {
    ...
    function getFomDb(array $selector, mysqli $connection){
        ...
        $result = $connection->query("SELECT *  FROM states WHERE ({$selectorStr}) LIMIT 1");
    ...
    function insert(mysqli $connection){
        ...
        $query = "INSERT INTO states ($fieldsStr) VALUES ($valuesStr)";
...
//            echo $connection->error;
    ...
    static function update(array $values,array $selector,$connection,$divider = 'AND'){
        ...
        $query = "UPDATE states SET $valuesStr WHERE $selectorStr";
