...
class Category {
    ...
    function getFomDb(array $selector, mysqli $connection){
        ...
        $result = $connection->query("SELECT *  FROM categories WHERE ({$selectorStr}) LIMIT 1");
    ...
    function insert(mysqli $connection){
        ...
        $query = "INSERT INTO categories ($fieldsStr) VALUES ($valuesStr)";
...
//            echo $connection->error;
    ...
    static function update(array $values,array $selector,$connection,$divider = 'AND'){
        ...
        $query = "UPDATE categories SET $valuesStr WHERE $selectorStr";
