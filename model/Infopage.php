...
class Infopage {
    ...
    function getFomDb(array $selector, mysqli $connection){
        ...
        $result = $connection->query("SELECT *  FROM info_pages WHERE ({$selectorStr}) LIMIT 1");
    ...
    function insert(mysqli $connection){
        ...
        $query = "INSERT INTO info_pages ($fieldsStr) VALUES ($valuesStr)";
    ...
    static function update(array $values,array $selector,$connection,$divider = 'AND'){
        ...
        $query = "UPDATE info_pages SET $valuesStr WHERE $selectorStr";
