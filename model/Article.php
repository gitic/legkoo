...
class Article {
    ...
    function getFomDb(array $selector, mysqli $connection){
        ...
        $result = $connection->query("SELECT *  FROM articles WHERE ({$selectorStr}) LIMIT 1");
    ...
    function insert(mysqli $connection){
        ...
        $query = "INSERT INTO articles ($fieldsStr) VALUES ($valuesStr)";
...
//            echo $connection->error;
    ...
    static function update(array $values,array $selector,$connection,$divider = 'AND'){
        ...
        $query = "UPDATE articles SET $valuesStr WHERE $selectorStr";
